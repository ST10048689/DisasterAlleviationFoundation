...
namespace DisasterAlleviationFoundation.Controllers
{
    public class DisastersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("DisasterID,Name,Description,Location,IsActive,StartDate")] Disaster disaster)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DisasterID,Name,Description,Location,IsActive,StartDate")] Disaster disaster)
        {
