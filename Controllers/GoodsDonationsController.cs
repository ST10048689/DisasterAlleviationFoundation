...
namespace DisasterAlleviationFoundation.Controllers
{
    public class GoodsDonationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("GoodsDonationID,DonorName,Description,Category,Quantity,DonationDate")] GoodsDonation goodsDonation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("GoodsDonationID,DonorName,Description,Category,Quantity,DonationDate")] GoodsDonation goodsDonation)
        {
